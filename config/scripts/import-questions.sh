...
echo "🔄 Import des questions depuis config/data/questions.json..."
...
QUESTION_COUNT=$(cat config/data/questions.json | python3 -c "import sys, json; print(len(json.load(sys.stdin)))")
